...
See [docs/MODULAR-MONOLITH-MIGRATION.md](../../docs/MODULAR-MONOLITH-MIGRATION.md), [docs/ROUTE-PARITY.md](./docs/ROUTE-PARITY.md), [docs/DATA-CUTOVER.md](./docs/DATA-CUTOVER.md), and [docs/PHASE-6-DECOMMISSION.md](./docs/PHASE-6-DECOMMISSION.md).
