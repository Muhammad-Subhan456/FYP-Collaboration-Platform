...
export default function SupervisorRequestsPage() {
  ...
  const requestsQuery = useQuery({
    queryKey: ["proposals", "supervisor-requests"],
    queryFn: proposalService.getSupervisorRequests,
  });

  const leaderIds =
    requestsQuery.data?.map(
      (r) => r.proposal.teamLeaderAuthUserId,
  ...
  if (requestsQuery.isLoading) return <DashboardSkeleton />;
