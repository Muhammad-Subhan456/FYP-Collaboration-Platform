...
export const STUDENT_NAV: NavItemConfig[] = [
  ...
  { title: "Deliverables", href: "/student/deliverables", icon: "Package" },
...
export const SUPERVISOR_NAV: NavItemConfig[] = [
  ...
  { title: "Proposals", href: "/supervisor/proposals", icon: "FileText" },
  ...
  { title: "Meetings", href: "/supervisor/meetings", icon: "Video" },
